...
| Status | Page title | Suggested URL | Long-tail targets |
| --- | --- | --- | --- |
| planned | Things First Apartment Renters Can Skip | `/guides/first-apartment-things-to-skip/` | things you do not need for first apartment; first apartment essentials not worth buying; first apartment overbuying |
